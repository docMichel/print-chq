...
def draw_barcode(c, code, left, top, right, bottom, font_size=12, show_text=False):
    ...
    # Calculer bar_width à partir de fontSize
    # Formule : plus fontSize est grand, plus les barres sont larges
    bar_width_mm = font_size / 40  # 12→0.3mm, 18→0.45mm, 24→0.6mm
